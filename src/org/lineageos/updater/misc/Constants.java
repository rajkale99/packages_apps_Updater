...
public final class Constants {
    ...
    public static final String PROP_DEVICE = "ro.coltos.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.coltos.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "lineage.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "coltos.updater.uri";
